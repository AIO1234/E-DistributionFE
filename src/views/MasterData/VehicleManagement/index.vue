...
export default {
  ...
  methods: {
    // get vehicles for this listing page - paginated, unlike the shared
    // commonmixins.getVehicles() cache which other forms use for dropdowns
    async getVehicles() {
      this.loading = true;
      ...
      const res = await VehiclesApi.allVehicles(payload);
      const pagination = res.data.data;

      this.vehicles = pagination.data;
