        ...
        >
          <template v-slot:top>
            <v-toolbar flat>
              <v-toolbar-title
                ><center>
                  <span class="table_topic">All Vehicles</span>
          ...
          >
            <!-- vehicle no -->
            <div v-if="header.key === 'vehicle_no'">
              <span v-if="props.item.vehicle_no !== null">
                {{ props.item.vehicle_no }}
              </span>
            </div>

            <!-- vehicle model -->
            <div v-if="header.key === 'vehicle_model'">
              <span v-if="props.item.vehicle_model !== null">
                {{ props.item.vehicle_model }}
              </span>
            </div>
...
export default {
  data() {
    return {
      ...
      show: false,
      headers: [
        { title: "Vehicle No", align: "start", key: "vehicle_no" },
        { title: "Vehicle Model", align: "start", key: "vehicle_model" },
