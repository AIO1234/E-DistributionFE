        ...
        <div class="send_distributer pt-3">
          ...
          <v-form v-model="isFormValid">
            ...
            <v-card
              ...
              v-for="(
                selecteddistributer, distributerindex
              ) in orderdistributers"
...
export default {
  ...
  methods: {
    ...
    async initializeData() {
      ...
      const res = await DistributerApi.EditDistributerOrder(payload);
      ...
      resArray.forEach((element) => {
        const items = [];
        // loop order items
        element.distributer_order_items.forEach((val) => {
        ...
        this.orderdistributers.push({
          distributer_id: element.distributer_id,
    ...
    async updateOrders() {
      ...
      await DistributerApi.UpdateDistributerOrders(this.form)
        .then(() => {
          this.loading = false;
