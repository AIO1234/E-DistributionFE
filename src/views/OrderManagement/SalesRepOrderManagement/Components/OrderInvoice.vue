                    ...
                    <v-row>
                      <v-col lg="7" class="left_col">
                        ...
                        <div class="invoice_to">
                          <span class="company_name">
                            {{ summary.salesrep.rep_name }}</span
                          >
                          <br />
                          <span class="company_text">{{
                            summary.salesrep.rep_address
                          }}</span>
                          <br />
                          <span class="company_text"
                            >{{ summary.salesrep.rep_mobile }}
                          </span>
                        </div>
                      </v-col>
...
export default {
  ...
  methods: {
    ...
    async orderSummary() {
      ...
      this.summary.distributer = res.data.data.salesrepordersummary.distributer;

      this.summary.salesrep = res.data.data.salesrepordersummary.salesrep;
